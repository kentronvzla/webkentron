...
class AuthTest extends TestCase {
    ...
    public function it_does_not_register_an_exisiting_user() {
        $this->visit('registration')
                ->type('invitado@kentron.com.ve', 'email')
                ->type('password', 'password')
                ->type('password', 'password_confirmation')
                ->type('Andre', 'first_name')
                ->type('Madarang', 'last_name')
...
//                ->see('Verifique su correo y siga la instrucciones!');
//    }
    ...
    public function it_does_not_find_an_email_for_forgot_password() {
        $this->visit('forgot_password')
                ...
                ->see('No podemos encontrar un usuario con dicho e-mail.');
    }
...
//
    ...
    {
        return $this->visit('login')
                    ->type('administrador@kentron.com.ve', 'email')
                    ->type('12345678', 'password')
                    ->press('Entrar');
    }
}
