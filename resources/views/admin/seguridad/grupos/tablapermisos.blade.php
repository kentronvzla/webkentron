                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2">
                        <div class="text-right">
                            ...
                            <button type="button" class="btn btn-danger btn-xs" 
                                    ...
                                    onclick="denegarPermisoPorGrupo('acordion{{$key}}{{$asignados}}','{{$grupo->id}}');">
                                <span class="glyphicon glyphicon-arrow-left"></span>
                            </button>
                            @else
                            <button type="button" class="btn btn-success btn-xs"
                                    title="Conceder permiso" 
                                    onclick="concederPermisoPorGrupo('acordion{{$key}}{{$asignados}}','{{$grupo->id}}');">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-danger btn-xs" 
                                title="Denegar permiso" 
                                onclick="denegarPermiso('{{$grupo->id}}','{{$key2}}');">
                            <span class="glyphicon glyphicon-arrow-left"></span>
                        </button>
                    </td>
                    @else
                    <td>
                        <button type="button" class="btn btn-success btn-xs" 
                                title="Conceder permiso" 
                                onclick="concederPermiso('{{$grupo->id}}','{{$key2}}');">
                            <span class="glyphicon glyphicon-arrow-right"></span>
                        </button>
                    </td>
                    @endif
