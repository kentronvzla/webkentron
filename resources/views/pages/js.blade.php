...
{!! Html::script('assets/js/libraries/jquery.noty.min.js') !!}
{!! Html::script('assets/js/libraries/jquery.photobox.min.js') !!}
{!! Html::script('assets/js/libraries/jquery.raty.min.js') !!}
{!! Html::script('assets/js/libraries/morris.min.js') !!}
